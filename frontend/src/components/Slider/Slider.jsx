...
//   return (
//     <>
//       <div className="mb-5 md:basis-1/2 lg:basis-1/3">
//         <Carousel
//           className="relative overflow-hidden bg-white-800 shadow-lg rounded-lg"
...
//           <CarouselItem className="flex items-center justify-center md:basis-1/1 lg:basis-1/3 pl-2 md:pl-4">
//             <TripCard
...
//           </CarouselContent>
//           <CarouselPrevious className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-white-800 text-red p-3 rounded-full shadow-lg hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-300 transition" />
//           <CarouselNext className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-white-800 text-red p-3 rounded-full shadow-lg hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-300 transition" />
//         </Carousel>
//       </div>
//     </>
//   );
